...
namespace Bottom_Control.基本控件
{
    //==============================================================
    //  作者：BAtoDA
    //  时间：2021/2/20 13:48:04 
    //  文件名：DAProcessEllipse 
    //  版本：V1.0.1  
    //  说明： 实现上位机底层控件 圆形进度条类 -不再公共运行时 
    //  修改者：***
    //  修改说明： 
    //==============================================================
    /// <summary>
    /// 实现上位机底层控件 圆形进度条类 -不再公共运行时 
    /// </summary>
    [ToolboxItem(true)]
    [Browsable(true)]
    [Description("实现上位机底层控件 圆形波形图类 -不再公共运行时")]
    public class DAProcessEllipse: UCProcessEllipse, TextBox_base
    {
        #region 实现接口参数
