...
namespace Bottom_Control.基本控件
{
    //==============================================================
    //  作者：BAtoDA
    //  时间：2021/2/18 21:16:55 
    //  文件名：DAAnalogMeter 
    //  版本：V1.0.1  
    //  说明：实现上位机底层控件 表盘类 -不再公共运行时
    //  修改者：***
    //  修改说明： 
    //==============================================================
    /// <summary>
    /// 实现上位机底层控件 表盘类 -不再公共运行时 
    /// </summary>
    [ToolboxItem(true)]
    [Browsable(true)]
    ...
    class DAAnalogMeter: UIAnalogMeter, TextBox_base
    {
        ...
        public string Control_Text { get => Convert.ToString(this.Value); set => this.Value=Convert.ToDouble(value); }
        /// <summary>
        /// 定时刷新 定时器
        /// </summary>
        ...
        public DAAnalogMeter()
        {
            ...
            this.BodyColor = Color.Transparent;
            this.NeedleColor = Color.YellowGreen;
