...
{
    public partial class ButtonBitForm1 : Sunny.UI.UIForm
    {
        int combox;
        string addeip, indx;
        public ButtonBitForm1(int combox, String indx, string addeip)
        {
            InitializeComponent();
            this.combox = combox;
            this.indx = indx;
        ...
        private void ButtonBitForm1_Shown(object sender, EventArgs e)
        {
